...
func restricted(res http.ResponseWriter, req *http.Request) {
	...
	tpl.ExecuteTemplate(res, "restricted.gohtml", u)
}
...
func login(res http.ResponseWriter, req *http.Request) {
	...
	if req.Method == http.MethodPost {
		username := req.FormValue("username")
		password := req.FormValue("password") // check if user exist with username
...
func logout(res http.ResponseWriter, req *http.Request) {
	...
	myCookie, _ := req.Cookie("myCookie") // delete the session delete(mapSessions, myCookie.Value) // remove the cookie
	myCookie = &http.Cookie{
		Name:   "myCookie",
		Value:  "",
		MaxAge: -1,
