...
// GetBookingsAll return all bookings booked by customers
...
// GetUsersAll returns all registered users
...
// RemoveUser delete user from DB
...
// RemoveVenue delete venue from DB
