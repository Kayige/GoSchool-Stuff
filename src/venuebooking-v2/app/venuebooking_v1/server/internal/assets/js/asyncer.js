window.asyncer = (function ($) {
  var selectorFormAsync = "form.asyncer",
    selectorErrorContainer = "#error-container",
    selectorSuccessContainer = "#success-container";

  // Show/Hide a spinner on form submission
  ...
  // onFormSubmit() submit form for POST,PUT,PATCH requests
  ...
  function init() {
    // set form submission listener for whole application
  ...
  $(function () {
    ...
    // preview file name on selecting new image
