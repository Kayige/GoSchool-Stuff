...
// HandleVenueListGET returns venue list html page
// get all venues from DB
// pass venue data to html page
...
// HandleVenueDetailsGET returns venue details page
// verify required query parameters
// get bookings by venue and pass data to html page
func (h *Handler) HandleVenueDetailsGET(w http.ResponseWriter, r *http.Request) {
	...
	// populate map with required data
	viewArgs := map[string]interface{}{
		"Header": map[string]interface{}{
			"DisplayName": currentUser.Fname,
		},
...
// HandleSearchVenueGET returns search venue page
// get searched venue from DB
// pass venue data to html page
...
// HandleNewVenueBookingGET returns html page for new venue booking
// get venue list from DB
// pass venue list data to html page
...
// HandleNewVenueBookingPOST create new venue booking
// verify required form parameters
// save new venue booking data into DB
// redirects to venue booking html page
...
// HandleAvailableVenuesGET fetch available venues from DB
// pass venue data to html page
...
// HandleBookedVenuesGET fetch booked venues from DB
// pass booked venue data to html page
